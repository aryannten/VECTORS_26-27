            ...
            <div className="flex items-center">
              ...
              >
                <img
                  ...
                  alt="VECTORS 2026-27"
                  className="h-11 sm:h-13 md:h-15 lg:h-16 w-auto max-w-[180px] sm:max-w-[230px] md:max-w-[280px] object-contain transition-transform duration-300 group-hover:scale-105 mix-blend-screen drop-shadow-[0_0_15px_rgba(30,255,160,0.3)]"
                />
              </a>
            </div>
